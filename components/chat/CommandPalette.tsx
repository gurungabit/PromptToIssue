  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 top-1/4 -translate-x-1/2 z-50 w-full max-w-lg">
        <div className="bg-white/90 dark:bg-zinc-950/80 backdrop-blur-xl border border-zinc-200 dark:border-zinc-700 rounded-xl shadow-2xl overflow-hidden">
          {/* Search input */}
          <div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-200 dark:border-zinc-800">
            ...
            <input
              ...
              className="flex-1 bg-transparent text-zinc-900 dark:text-white placeholder:text-zinc-500 focus:outline-none"
            />
            <button
              onClick={handleClose}
          ...
          <div className="max-h-80 overflow-y-auto py-2">
            ...
            <button
              ...
              className="w-full px-4 py-2 flex items-center gap-3 text-left hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
            >
              <div className="w-8 h-8 bg-zinc-100 dark:bg-zinc-800 rounded-lg flex items-center justify-center">
                <Plus className="w-4 h-4 text-zinc-500 dark:text-zinc-400" />
              </div>
              <div>
                <div className="text-sm font-medium text-zinc-900 dark:text-white">New Chat</div>
            ...
            {filteredChats.length > 0 && (
              <div className="my-2 mx-4 border-t border-zinc-200 dark:border-zinc-800" />
            )}
