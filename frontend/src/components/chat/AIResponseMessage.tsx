                  ...
                  <div className="flex items-start justify-between mb-4">
                    {isEditing ? (
                      <input
                        ...
                        onChange={(e) => updateEditedTicket(index, 'title', e.target.value as TicketFieldValue)}
                    ...
                    <div className="flex items-center space-x-2">
                      {isEditing ? (
                        <select
                          ...
                          onChange={(e) => updateEditedTicket(index, 'priority', e.target.value as TicketFieldValue)}
                  ...
                  <div className="mb-4">
                    ...
                    {isEditing ? (
                      <textarea
                        ...
                        onChange={(e) => updateEditedTicket(index, 'description', e.target.value as TicketFieldValue)}
                        rows={3}
                            ...
                            <div key={i} className="flex items-center space-x-2">
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  updateEditedTicket(index, 'acceptanceCriteria', newCriteria as TicketFieldValue);
                                }}
