        ...
        <div className='flex items-center justify-between'>
          <div className='flex items-center space-x-3 min-w-0 flex-1'>
            {selectedOption && showGroups && (
              <div className='flex-shrink-0'>{getTypeIcon(selectedOption.type || '')}</div>
            )}
                  ...
                  {typeOptions.map(option => (
                    ...
                    >
                      <div className='flex items-center space-x-3'>
                        ...
                        <div className='min-w-0 flex-1'>
                          <div
                            className={`font-medium truncate text-sm ${value === option.value ? 'text-blue-700 dark:text-blue-300' : 'text-gray-900 dark:text-white'}`}
                          >
                            {option.label}
                          </div>
                          {option.description && (
